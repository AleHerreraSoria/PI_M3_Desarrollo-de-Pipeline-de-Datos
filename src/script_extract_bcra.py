...
def validate_data(data: dict, expected_currency: str) -> bool:
    ...
    # 1. Validar completitud (que todas las claves existan y no sean nulas)
    for key in required_keys:
        if key not in data or data[key] is None:
            print(f"ERROR DE CALIDAD: El campo requerido '{key}' está ausente o es nulo.")
            return False

    # 2. Validar tipos y consistencia
...
if __name__ == "__main__":
    ...
    # Solo si los datos existen y son válidos, procedemos a subirlos.
